...
Commands are primitive instructions to make visual novels on `OpenNovel`.
Most commands start with `@` mark.

You don't need to remember the names of the commands;
You can refer this document and copy-paste-modify the sample.
