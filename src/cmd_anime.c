...
/* The size of the registered animations. */
#define REG_SIZE	REG_ANIME_COUNT
...
/*
 * Option name to variable mappings.
 */
struct option_table {
	const char *name;
	bool *flag;
