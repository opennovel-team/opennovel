...
static bool s2_register_bgvoice(struct wms_runtime *rt);
...
struct wms_ffi_func_tbl ffi_func_tbl[] = {
	...
	{s2_register_bgvoice, "s2_register_bgvoice", {"file"}},

	/* For compatibility. */
	{s2_get_variable, "onvl_get_variable", {"index", NULL}},
	{s2_set_variable, "onvl_set_variable", {"index", "value", NULL}},
	{s2_get_name_variable, "onvl_get_name_variable", {"index", NULL}},
	{s2_get_year, "onvl_get_year", {NULL}},
	{s2_get_month, "onvl_get_month", {NULL}},
	{s2_get_day, "onvl_get_day", {NULL}},
	{s2_get_hour, "onvl_get_hour", {NULL}},
	{s2_get_minute, "onvl_get_minute", {NULL}},
	{s2_get_second, "onvl_get_second", {NULL}},
	{s2_get_wday, "onvl_get_wday",{NULL}},
	{s2_set_name_variable, "onvl_set_name_variable", {"index", "value", NULL}},
	{s2_random, "onvl_random", {NULL}},
	{s2_round, "onvl_round", {"value",NULL}},
	{s2_ceil, "onvl_ceil", {"value",NULL}},
	{s2_floor, "onvl_floor", {"value",NULL}},
	{s2_set_config, "onvl_set_config", {"key", "value", NULL}},
	{s2_reflect_msgbox_and_namebox_config, "onvl_reflect_msgbox_and_namebox_config", {NULL}},
	{s2_reflect_font_config, "onvl_reflect_font_config", {NULL}},
	{s2_clear_history, "onvl_clear_history", {NULL}},
	{s2_clear_msgbox, "onvl_clear_msgbox", {NULL}},
	{s2_clear_namebox, "onvl_clear_namebox", {NULL}},
	{s2_hide_msgbox, "onvl_hide_msgbox", {NULL}},
	{s2_hide_namebox, "onvl_hide_namebox", {NULL}},
	{s2_save_global, "onvl_save_global", {NULL}},
	{s2_push_stage, "onvl_push_stage", {NULL}},
	{s2_pop_stage, "onvl_pop_stage", {NULL}},
	{s2_remove_local_save, "onvl_remove_local_save", {"index", NULL}},
	{s2_remove_global_save, "onvl_remove_global_save", {NULL}},
	{s2_reset_local_variables, "onvl_reset_local_variables", {NULL}},
	{s2_reset_global_variables, "onvl_reset_global_variables", {NULL}},
	{s2_register_bgvoice, "onvl_register_bgvoice", {NULL}},
};
...
static bool s2_register_bgvoice(struct wms_runtime *rt)
{
	struct wms_value *file;
	const char *file_s;

	assert(rt != NULL);

	/* Get the argument pointers. */
	if (!wms_get_var_value(rt, "file", &file))
		return false;

	/* Get the argument values. */
	if (!wms_get_str_value(rt, file, &file_s))
		return false;

	/* Rgister a BGVoice. */
	register_bgvoice(file_s);
