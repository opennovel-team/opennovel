...
struct insn_item {
	...
	/* For compatibility. */
	{"@章",		COMMAND_CHAPTER,	1,	1},
	{"@bgm",	COMMAND_MUSIC,		1,	2},
	{"@cha",	COMMAND_MOVE,		6,	6},
	{"@chsx",	COMMAND_CHCH,		0,	30},
	{"@all",	COMMAND_CHCH,		0,	30},
	{"@gui",	COMMAND_MENU,		1,	2},
	{"@load",	COMMAND_STORY,		1,	2},
	{"@se",		COMMAND_SOUND,		1,	2},
	{"@setconfig",	COMMAND_CONFIG,		1,	2},
	{"@vol",	COMMAND_VOLUME,		2,	3},
	{"@pencil",	COMMAND_TEXT,		1,	2},
	{"@wait",	COMMAND_TIME,		1,	2},
	{"@wms",	COMMAND_PLUGIN,		1,	11},
...
const char *get_script_file_name(void)
{
	...
	return cur_script;
#endif
	return cmd[cur_index].file;
}

/*
 * スクリプトファイル名を取得する
 */
const char *get_script_file_name_on_error(void)
{
	if (cur_script == NULL)
		return "";
