	...
	bool use_tategaki)
{
	...
	if (is_quoted_serif(msg) && !use_tategaki)
		context->left_margin += get_glyph_width(font, font_size, U32_C('　', 0x3000));
}
...
{
	switch (wc) {
	case U32_C('、', 0x3001): return U32_C('︑', 0xfe11);
	case U32_C('，', 0xff0c): return U32_C('︐', 0xfe10);
	case U32_C('。', 0x3002): return U32_C('︒', 0xfe12);
	case U32_C('（', 0xff08): return U32_C('︵', 0xfe35);
	case U32_C('）', 0xff09): return U32_C('︶', 0xfe36);
	case U32_C('｛', 0xff5b): return U32_C('︷', 0xfe37);
	case U32_C('｝', 0xff5d): return U32_C('︸', 0xfe38);
	case U32_C('「', 0x300c): return U32_C('﹁', 0xfe41);
	case U32_C('」', 0x300d): return U32_C('﹂', 0xfe42);
	case U32_C('『', 0x300e): return U32_C('﹃', 0xfe43);
	case U32_C('』', 0x300f): return U32_C('﹄', 0xfe44);
	case U32_C('【', 0x3010): return U32_C('︻', 0xfe3b);
	case U32_C('】', 0x3011): return U32_C('︼', 0xfe3c);
	case U32_C('［', 0xff3b): return U32_C('﹇', 0xfe47);
	case U32_C('］', 0xff3d): return U32_C('﹈', 0xfe48);
	case U32_C('〔', 0x3014): return U32_C('︹', 0xfe39);
	case U32_C('〕', 0x3015): return U32_C('︺', 0xfe3a);
	case U32_C('…', 0x2026): return U32_C('︙', 0xfe19);
	case U32_C('‥', 0x2025): return U32_C('︰', 0xfe30);
	case U32_C('ー', 0x30fc): return U32_C('丨', 0x4e28);
	case U32_C('─', 0x2500): return U32_C('丨', 0x4e28);
	case U32_C('〈', 0x3008): return U32_C('︿', 0xfe3f);
	case U32_C('〈', 0x2329): return U32_C('︿', 0xfe3f);
	case U32_C('〉', 0x3009): return U32_C('⟩', 0xfe40);
	case U32_C('〉', 0x232a): return U32_C('⟩', 0xfe40);
	case U32_C('《', 0x300a): return U32_C('︽', 0xfe3d);
	case U32_C('》', 0x300b): return U32_C('︾', 0xfe3e);
	case U32_C('〖', 0x3016): return U32_C('︗', 0xfe17);
	case U32_C('〗', 0x3017): return U32_C('︘', 0xfe18);
	default:
		break;
	}
	return wc;
...
{
	switch (wc) {
	case U32_C('︑', 0xfe11): return true;
	case U32_C('︐', 0xfe10): return true;
	case U32_C('︒', 0xfe12): return true;
	case U32_C('︵', 0xfe35): return true;
	case U32_C('︶', 0xfe36): return true;
	case U32_C('︷', 0xfe37): return true;
	case U32_C('︸', 0xfe38): return true;
	case U32_C('﹁', 0xfe41): return true;
	case U32_C('﹂', 0xfe42): return true;
	case U32_C('﹃', 0xfe43): return true;
	case U32_C('﹄', 0xfe44): return true;
	case U32_C('︻', 0xfe3b): return true;
	case U32_C('︼', 0xfe3c): return true;
	case U32_C('﹇', 0xfe47): return true;
	case U32_C('﹈', 0xfe48): return true;
	case U32_C('︹', 0xfe39): return true;
	case U32_C('︺', 0xfe3a): return true;
	case U32_C('︙', 0xfe19): return true;
	case U32_C('︰', 0xfe30): return true;
	case U32_C('丨', 0x4e28): return true;
	default:
		break;
	}
	return false;
...
{
	switch (wc) {
	case U32_C('ぁ', 0x3041): return true;
	case U32_C('ぃ', 0x3043): return true;
	case U32_C('ぅ', 0x3045): return true;
	case U32_C('ぇ', 0x3047): return true;
	case U32_C('ぉ', 0x3049): return true;
	case U32_C('っ', 0x3063): return true;
	case U32_C('ゃ', 0x3083): return true;
	case U32_C('ゅ', 0x3085): return true;
	case U32_C('ょ', 0x3087): return true;
	case U32_C('ゎ', 0x308e): return true;
	case U32_C('ゕ', 0x3095): return true;
	case U32_C('ゖ', 0x3096): return true;
	case U32_C('ァ', 0x30a1): return true;
	case U32_C('ィ', 0x30a3): return true;
	case U32_C('ゥ', 0x30a5): return true;
	case U32_C('ェ', 0x30a7): return true;
	case U32_C('ォ', 0x30a9): return true;
	case U32_C('ッ', 0x30c3): return true;
	case U32_C('ャ', 0x30e3): return true;
	case U32_C('ュ', 0x30e5): return true;
	case U32_C('ョ', 0x30e7): return true;
	case U32_C('ヮ', 0x30ee): return true;
	case U32_C('ヵ', 0x30f5): return true;
	case U32_C('ヶ', 0x30f6): return true;
	default: break;
	}
	return false;
}
