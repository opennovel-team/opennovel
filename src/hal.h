 ...
 */
#if defined(OPENNOVEL_TARGET_ANDROID) || defined(OPENNOVEL_TARGET_WASM) || (defined(OPENNOVEL_TARGET_POSIX) && (defined(USE_X11_OPENGL) || defined(USE_X11_VULKAN))) || defined(USE_QT)
