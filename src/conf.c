...
/* Sound Effects */
char *conf_msgbox_btn_auto_enter_se;
char *conf_msgbox_btn_skip_enter_se;
char *conf_msgbox_btn_hide_enter_se;
char *conf_msgbox_btn_hide_leave_se;
...
static struct rule {
	...
	{'s',	"msgbox.hover.image",		&conf_msgbox_hover_image,		OPTIONAL,	SAVE},
	...
	{'i',	"msgbox.font.outline.g",	&conf_msgbox_font_outline_g,		OPTIONAL,	SAVE},
	{'i',	"msgbox.font.outline.b",	&conf_msgbox_font_outline_b,		OPTIONAL,	SAVE},
	{'i',	"msgbox.font.ruby",		&conf_msgbox_font_ruby,			OPTIONAL,	SAVE},
	{'b',	"msgbox.font.tategaki",		&conf_msgbox_font_tategaki,		OPTIONAL,	SAVE},
	{'b',	"msgbox.fill",			&conf_msgbox_fill,			OPTIONAL,	SAVE},
	{'i',	"msgbox.fill.r",		&conf_msgbox_fill_r,			OPTIONAL,	SAVE},
	{'i',	"msgbox.fill.g",		&conf_msgbox_fill_g,			OPTIONAL,	SAVE},
	{'i',	"msgbox.fill.b",		&conf_msgbox_fill_b,			OPTIONAL,	SAVE},
	{'b',	"msgbox.dim",			&conf_msgbox_dim,			OPTIONAL,	SAVE},
	...
	{'i',	"msgbox.btn.save.x",		&conf_msgbox_btn_save_x,		OPTIONAL,	SAVE},
	{'i',	"msgbox.btn.save.y",		&conf_msgbox_btn_save_y,		OPTIONAL,	SAVE},
	{'i',	"msgbox.btn.save.width",	&conf_msgbox_btn_save_width,		OPTIONAL,	SAVE},
	{'i',	"msgbox.btn.save.height",	&conf_msgbox_btn_save_height,		OPTIONAL,	SAVE},
	{'i',	"msgbox.btn.load.x",		&conf_msgbox_btn_load_x,		OPTIONAL,	SAVE},
	{'i',	"msgbox.btn.load.y",		&conf_msgbox_btn_load_y,		OPTIONAL,	SAVE},
	{'i',	"msgbox.btn.load.width",	&conf_msgbox_btn_load_width,		OPTIONAL,	SAVE},
	{'i',	"msgbox.btn.load.height",	&conf_msgbox_btn_load_height,		OPTIONAL,	SAVE},
	{'i',	"msgbox.btn.auto.x",		&conf_msgbox_btn_auto_x,		OPTIONAL,	SAVE},
	{'i',	"msgbox.btn.auto.y",		&conf_msgbox_btn_auto_y,		OPTIONAL,	SAVE},
	{'i',	"msgbox.btn.auto.width",	&conf_msgbox_btn_auto_width,		OPTIONAL,	SAVE},
	{'i',	"msgbox.btn.auto.height",	&conf_msgbox_btn_auto_height,		OPTIONAL,	SAVE},
	{'i',	"msgbox.btn.skip.x",		&conf_msgbox_btn_skip_x,		OPTIONAL,	SAVE},
	{'i',	"msgbox.btn.skip.y",		&conf_msgbox_btn_skip_y,		OPTIONAL,	SAVE},
	{'i',	"msgbox.btn.skip.width",	&conf_msgbox_btn_skip_width,		OPTIONAL,	SAVE},
	{'i',	"msgbox.btn.skip.height",	&conf_msgbox_btn_skip_height,		OPTIONAL,	SAVE},
	{'i',	"msgbox.btn.history.x",		&conf_msgbox_btn_history_x,		OPTIONAL,	SAVE},
	{'i',	"msgbox.btn.history.y",		&conf_msgbox_btn_history_y,		OPTIONAL,	SAVE},
	{'i',	"msgbox.btn.history.width",	&conf_msgbox_btn_history_width,		OPTIONAL,	SAVE},
	{'i',	"msgbox.btn.history.height",	&conf_msgbox_btn_history_height,	OPTIONAL,	SAVE},
	{'i',	"msgbox.btn.config.x",		&conf_msgbox_btn_config_x,		OPTIONAL,	SAVE},
	{'i',	"msgbox.btn.config.y",		&conf_msgbox_btn_config_y,		OPTIONAL,	SAVE},
	{'i',	"msgbox.btn.config.width",	&conf_msgbox_btn_config_width,		OPTIONAL,	SAVE},
	{'i',	"msgbox.btn.config.height",	&conf_msgbox_btn_config_height,		OPTIONAL,	SAVE},
	{'i',	"msgbox.btn.hide.x",		&conf_msgbox_btn_hide_x,		OPTIONAL,	SAVE},
	{'i',	"msgbox.btn.hide.y",		&conf_msgbox_btn_hide_y,		OPTIONAL,	SAVE},
	{'i',	"msgbox.btn.hide.width",	&conf_msgbox_btn_hide_width,		OPTIONAL,	SAVE},
	{'i',	"msgbox.btn.hide.height",	&conf_msgbox_btn_hide_height,		OPTIONAL,	SAVE},
	{'s',	"msgbox.btn.auto.enter.se",	&conf_msgbox_btn_auto_enter_se,		OPTIONAL,	SAVE},
	{'s',	"msgbox.btn.skip.enter.se",	&conf_msgbox_btn_skip_enter_se,		OPTIONAL,	SAVE},
	{'s',	"msgbox.btn.hide.enter.se",	&conf_msgbox_btn_hide_enter_se,		OPTIONAL,	SAVE},
	{'s',	"msgbox.btn.hide.leave.se",	&conf_msgbox_btn_hide_leave_se,		OPTIONAL,	SAVE},
	...
	{'i',	"namebox.font.outline.g",	&conf_namebox_font_outline_g,		OPTIONAL,	SAVE},
	{'i',	"namebox.font.outline.b",	&conf_namebox_font_outline_b,		OPTIONAL,	SAVE},
	...
	{'i',	"choose.font.outline.g",	&conf_choose_font_outline_g,		OPTIONAL,	SAVE},
	{'i',	"choose.font.outline.b",	&conf_choose_font_outline_b,		OPTIONAL,	SAVE},
	...
	{'i',	"menu.save.font.outline.g",	&conf_menu_save_font_outline_g,		OPTIONAL,	SAVE},
	{'i',	"menu.save.font.outline.b",	&conf_menu_save_font_outline_b,		OPTIONAL,	SAVE},
	...
	{'i',	"menu.history.font.outline.g",	&conf_menu_history_font_outline_g,	OPTIONAL,	SAVE},
	{'i',	"menu.history.font.outline.b",	&conf_menu_history_font_outline_b,	OPTIONAL,	SAVE},
...
static bool save_value(const char *k, const char *v)
{
	...
	for (i = 0; i < RULE_TBL_SIZE; i++) {
		...
		if (rule_tbl[i].type == 'b') {
			*(bool *)rule_tbl[i].var_ptr = (strcmp(v, "yes") == 0 || strcmp(v, "1") == 0) ? true : false;
