...
cd brotli-1.1.0
$MAKE -j`nproc` -f ../../../../external/brotli.mk CC="$CC" CFLAGS="$CFLAGS -w" AR="$AR" PREFIX="$PREFIX"
...
cd bzip2-1.0.6
$MAKE -j`nproc` -f ../../../../external/bzip2.mk CC="$CC" CFLAGS="$CFLAGS -w" AR="$AR" PREFIX="$PREFIX"
...
$MAKE -j`nproc` -f ../../../../external/libwebp.mk CC="$CC" CFLAGS="$CFLAGS -w" AR="$AR" PREFIX="$PREFIX"
...
cd zlib-1.2.11
$MAKE -j`nproc` -f ../../../../external/zlib.mk CC="$CC" CFLAGS="$CFLAGS -w" AR="$AR" PREFIX="$PREFIX"
...
sed \
    ...
    > pnglibconf.h
$MAKE -j`nproc` -f ../../../../external/libpng.mk CC="$CC" CFLAGS="$CFLAGS -w" AR="$AR" PREFIX="$PREFIX"
...
$MAKE -j`nproc` -f ../../../../external/jpeg9.mk CC="$CC" CFLAGS="$CFLAGS -w" AR="$AR" PREFIX="$PREFIX"
...
$MAKE -j`nproc` -f ../../../../external/libogg.mk CC="$CC" CFLAGS="$CFLAGS -w" AR="$AR" PREFIX="$PREFIX"
...
cd libvorbis-1.3.6
$MAKE -j`nproc` -f ../../../../external/libvorbis.mk CC="$CC" CFLAGS="$CFLAGS -w" AR="$AR" PREFIX="$PREFIX"
...
$MAKE -j`nproc` -f ../../../../external/freetype2.mk CC="$CC" CFLAGS="$CFLAGS -w" AR="$AR" PREFIX="$PREFIX"
